...
import org.ys.transaction.domain.inteface.admin.AdminStatisticsService;
...
public class AdminStatisticsServiceImpl implements AdminStatisticsService {
    ...
    @Override
    public DomainResult getDashboardStats() {
        try {
            ...
            return DomainResult.error("获取统计数据失败：" + e.getMessage());
        }
    }
