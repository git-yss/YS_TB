...
public class AdminMarketingController {
    ...
    @Resource
    private org.ys.transaction.domain.inteface.admin.AdminCouponService adminCouponService;

    @Resource
    private org.ys.transaction.domain.inteface.admin.AdminSeckillService adminSeckillService;
